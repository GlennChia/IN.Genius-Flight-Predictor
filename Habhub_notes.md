...
6. By default, the slider for altitude is set to "Surface". Seeing the pattern tallies with the flight path since the balloon heads South West first ![](assets/13_windy_surface.png)![](C:\Users\Glenn Chia\AppData\Roaming\Typora\typora-user-images\1547874847421.png)
